...
import { createMessage, getMessagesInConversation } from '../controller/message.controller.js'
...
export default (router) => {
  ...
  router.get('/conversation/:id/messages', isAuthenticated, checkConversationStatus, getMessagesInConversation)
